...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 df 7a 10 80 	movl   $0x80107adf,(%esp)
...
80103feb:	68 df 7a 10 80       	push   $0x80107adf
...
801054ce:	e8 0d 1c 00 00       	call   801070e0 <shm_close>
...
80106fa6:	bb fc 54 11 80       	mov    $0x801154fc,%ebx
80106fab:	83 ec 28             	sub    $0x28,%esp
80106fae:	8b 7d 08             	mov    0x8(%ebp),%edi

  acquire(&(shm_table.lock));
80106fb1:	68 c0 54 11 80       	push   $0x801154c0
80106fb6:	e8 e5 d2 ff ff       	call   801042a0 <acquire>
  uint sz = PGROUNDUP(myproc()->sz);
80106fbb:	e8 c0 c7 ff ff       	call   80103780 <myproc>
80106fc0:	8b 30                	mov    (%eax),%esi
...
int shm_open(int id, char **pointer) {
  ...
  acquire(&(shm_table.lock));
  uint sz = PGROUNDUP(myproc()->sz);
80106fc7:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106fcd:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106fd3:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80106fd6:	eb 13                	jmp    80106feb <shm_open+0x4b>
80106fd8:	90                   	nop
80106fd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106fe0:	83 c3 0c             	add    $0xc,%ebx
  uint pa;
  int i;
  int fg = 0;

  for (i = 0; i< 64; i++) {
80106fe3:	81 fb fc 57 11 80    	cmp    $0x801157fc,%ebx
80106fe9:	74 45                	je     80107030 <shm_open+0x90>
    if(shm_table.shm_pages[i].id == id) {
80106feb:	39 7b f8             	cmp    %edi,-0x8(%ebx)
80106fee:	75 f0                	jne    80106fe0 <shm_open+0x40>
      fg = 1;
      pa = V2P(shm_table.shm_pages[i].frame);
80106ff0:	8b 43 fc             	mov    -0x4(%ebx),%eax
80106ff3:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
      //map it to the existing page (use mappages())
      mappages(myproc()->pgdir,(char*)sz, PGSIZE, pa, PTE_W|PTE_U);
80106ff9:	e8 82 c7 ff ff       	call   80103780 <myproc>
80106ffe:	83 ec 0c             	sub    $0xc,%esp
80107001:	6a 06                	push   $0x6
80107003:	56                   	push   %esi
80107004:	68 00 10 00 00       	push   $0x1000
80107009:	ff 75 e4             	pushl  -0x1c(%ebp)
8010700c:	ff 70 04             	pushl  0x4(%eax)
8010700f:	e8 dc f7 ff ff       	call   801067f0 <mappages>
      //increment the refcnt
      shm_table.shm_pages[i].refcnt++;
80107014:	83 03 01             	addl   $0x1,(%ebx)
80107017:	83 c3 0c             	add    $0xc,%ebx
8010701a:	83 c4 20             	add    $0x20,%esp
  uint sz = PGROUNDUP(myproc()->sz);
  uint pa;
  int i;
  int fg = 0;
  ...
  for (i = 0; i< 64; i++) {
8010701d:	81 fb fc 57 11 80    	cmp    $0x801157fc,%ebx
    if(shm_table.shm_pages[i].id == id) {
      fg = 1;
80107023:	b9 01 00 00 00       	mov    $0x1,%ecx
  uint sz = PGROUNDUP(myproc()->sz);
  uint pa;
  int i;
  int fg = 0;
  ...
  for (i = 0; i< 64; i++) {
80107028:	75 c1                	jne    80106feb <shm_open+0x4b>
8010702a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107030:	ba c0 54 11 80       	mov    $0x801154c0,%edx
80107035:	31 c0                	xor    %eax,%eax
80107037:	eb 12                	jmp    8010704b <shm_open+0xab>
...
80107043:	83 c2 0c             	add    $0xc,%edx
80107046:	83 f8 40             	cmp    $0x40,%eax
80107049:	74 5d                	je     801070a8 <shm_open+0x108>
    if(fg == 0){
8010704b:	85 c9                	test   %ecx,%ecx
8010704d:	75 f1                	jne    80107040 <shm_open+0xa0>
      if(shm_table.shm_pages[i].id == 0) {
8010704f:	8b 5a 34             	mov    0x34(%edx),%ebx
80107052:	85 db                	test   %ebx,%ebx
80107054:	75 ea                	jne    80107040 <shm_open+0xa0>
        //find the index of first available page and assign id to the page (page.id = id)
        shm_table.shm_pages[i].id = id;
80107056:	8d 04 40             	lea    (%eax,%eax,2),%eax
80107059:	8d 1c 85 c0 54 11 80 	lea    -0x7feeab40(,%eax,4),%ebx
80107060:	89 7b 34             	mov    %edi,0x34(%ebx)
        //page.frame = kalloc()
        shm_table.shm_pages[i].frame = kalloc();
80107063:	e8 28 b4 ff ff       	call   80102490 <kalloc>
        //increment the refcnt
        shm_table.shm_pages[i].refcnt++;
80107068:	83 43 3c 01          	addl   $0x1,0x3c(%ebx)
...
8010706c:	83 ec 04             	sub    $0x4,%esp
    if(fg == 0){
      if(shm_table.shm_pages[i].id == 0) {
        ...
        //page.frame = kalloc()
        shm_table.shm_pages[i].frame = kalloc();
8010706f:	89 43 38             	mov    %eax,0x38(%ebx)
        //increment the refcnt
        shm_table.shm_pages[i].refcnt++;
        //Initialize the frame allocated to 0. (use memset())
        memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
...
8010707a:	e8 91 d3 ff ff       	call   80104410 <memset>
        //map the new page (using mappages())
        pa = V2P(shm_table.shm_pages[i].frame);
8010707f:	8b 5b 38             	mov    0x38(%ebx),%ebx
        mappages(myproc()->pgdir,(char*)sz, PGSIZE, pa, PTE_W|PTE_U);
80107082:	e8 f9 c6 ff ff       	call   80103780 <myproc>
80107087:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
        //increment the refcnt
        shm_table.shm_pages[i].refcnt++;
        //Initialize the frame allocated to 0. (use memset())
        memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
...
8010709a:	ff 75 e4             	pushl  -0x1c(%ebp)
8010709d:	ff 70 04             	pushl  0x4(%eax)
801070a0:	e8 4b f7 ff ff       	call   801067f0 <mappages>
        break;
801070a5:	83 c4 20             	add    $0x20,%esp
      }
    }
  } 
  //return the address of the page through the pointer variable. πointer = (char *)size;
  *pointer=(char*)myproc()->sz;
801070a8:	e8 d3 c6 ff ff       	call   80103780 <myproc>
801070ad:	8b 10                	mov    (%eax),%edx
801070af:	8b 45 0c             	mov    0xc(%ebp),%eax
801070b2:	89 10                	mov    %edx,(%eax)
  //update current process size
  myproc()->sz += PGSIZE;
801070b4:	e8 c7 c6 ff ff       	call   80103780 <myproc>
801070b9:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
  //release lock
  release(&(shm_table.lock));
801070bf:	83 ec 0c             	sub    $0xc,%esp
801070c2:	68 c0 54 11 80       	push   $0x801154c0
801070c7:	e8 f4 d2 ff ff       	call   801043c0 <release>
  return 0; 
...
801070e4:	83 ec 10             	sub    $0x10,%esp
801070e7:	8b 5d 08             	mov    0x8(%ebp),%ebx

//you write this too!
  //acquire a lock on shm_tabl
  acquire(&(shm_table.lock));
801070ea:	68 c0 54 11 80       	push   $0x801154c0
801070ef:	e8 ac d1 ff ff       	call   801042a0 <acquire>
801070f4:	b8 fc 54 11 80       	mov    $0x801154fc,%eax
801070f9:	83 c4 10             	add    $0x10,%esp
801070fc:	eb 0c                	jmp    8010710a <shm_close+0x2a>
801070fe:	66 90                	xchg   %ax,%ax
80107100:	83 c0 0c             	add    $0xc,%eax
  //loop through all 64 pages and search if there exists a page whose id is same as id given as an argument 
  for (int i = 0; i< 64; i++) {
80107103:	3d fc 57 11 80       	cmp    $0x801157fc,%eax
80107108:	74 2f                	je     80107139 <shm_close+0x59>
    if(shm_table.shm_pages[i].id == id) {
8010710a:	3b 58 f8             	cmp    -0x8(%eax),%ebx
8010710d:	75 f1                	jne    80107100 <shm_close+0x20>
    //if found, decrement the refcnt 
      shm_table.shm_pages[i].refcnt--;
8010710f:	8b 08                	mov    (%eax),%ecx
80107111:	8d 51 ff             	lea    -0x1(%ecx),%edx
      //if refcnt is = 0:
      if(shm_table.shm_pages[i].refcnt == 0) {
80107114:	85 d2                	test   %edx,%edx
  acquire(&(shm_table.lock));
  //loop through all 64 pages and search if there exists a page whose id is same as id given as an argument 
  for (int i = 0; i< 64; i++) {
    if(shm_table.shm_pages[i].id == id) {
    //if found, decrement the refcnt 
      shm_table.shm_pages[i].refcnt--;
80107116:	89 10                	mov    %edx,(%eax)
      //if refcnt is = 0:
      if(shm_table.shm_pages[i].refcnt == 0) {
80107118:	75 e6                	jne    80107100 <shm_close+0x20>
      //set all the values of the page back to 0
        shm_table.shm_pages[i].id = 0;
8010711a:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
        shm_table.shm_pages[i].frame = 0;
80107121:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
80107128:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].refcnt = 0;
8010712b:	c7 40 f4 00 00 00 00 	movl   $0x0,-0xc(%eax)
...
//you write this too!
  ...
  //loop through all 64 pages and search if there exists a page whose id is same as id given as an argument 
  for (int i = 0; i< 64; i++) {
80107132:	3d fc 57 11 80       	cmp    $0x801157fc,%eax
80107137:	75 d1                	jne    8010710a <shm_close+0x2a>
        shm_table.shm_pages[i].refcnt = 0;
      }
    }
  }
...
8010713c:	68 c0 54 11 80       	push   $0x801154c0
80107141:	e8 7a d2 ff ff       	call   801043c0 <release>
  return 0; 
}
80107146:	31 c0                	xor    %eax,%eax
80107148:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010714b:	c9                   	leave  
8010714c:	c3                   	ret    
